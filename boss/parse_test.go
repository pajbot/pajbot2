		...
		/*
			{
				...
				expected: common.Msg{Color: "#FF468F", Displayname: "Ampzyh", Emotes: []common.Emote{}, Mod: false, Subscriber: true, Turbo: false, Usertype: "", Username: "ampzyh", Channel: "pajlada", Text: "LIKE THAT SOn", MessageType: "privmsg", Me: false, Length: 0},
			},
			{
				...
				expected: common.Msg{Color: "", Displayname: "alfredmechinisme", Emotes: []common.Emote{common.Emote{EmoteType: "twitch", ID: "29", Name: "", Pos: []string(nil), Count: 1}}, Mod: false, Subscriber: false, Turbo: false, Usertype: "", Username: "alfredmechinisme", Channel: "pajlada", Text: "Ha MVGame", MessageType: "privmsg", Me: false, Length: 0},
			},
			{
				...
				expected: common.Msg{Color: "#FF468F", Displayname: "Ampzyh", Emotes: []common.Emote{}, Mod: false, Subscriber: true, Turbo: false, Usertype: "", Username: "ampzyh", Channel: "pajlada", Text: "OH HOHO GANGIUNG UP", MessageType: "privmsg", Me: false, Length: 0},
			},
			{
				...
				expected: common.Msg{Color: "#2E8B57", Displayname: "pajbot", Emotes: []common.Emote{}, Mod: true, Subscriber: true, Turbo: false, Usertype: "mod", Username: "pajbot", Channel: "pajlada", Text: "pajbot has been online for 6 hours and 42 minutes", MessageType: "privmsg", Me: false, Length: 0},
			},
			{
				...
				expected: common.Msg{Color: "#00FF7F", Displayname: "Skyrisenow", Emotes: []common.Emote{}, Mod: false, Subscriber: false, Turbo: false, Usertype: "", Username: "skyrisenow", Channel: "pajlada", Text: "!stats ruined", MessageType: "privmsg", Me: false, Length: 0},
			},
			{
				...
				expected: common.Msg{Color: "#0B8D6F", Displayname: "nuuls", Emotes: []common.Emote{common.Emote{EmoteType: "twitch", ID: "3287", Name: "", Pos: []string(nil), Count: 1}}, Mod: false, Subscriber: true, Turbo: true, Usertype: "", Username: "nuuls", Channel: "pajlada", Text: "MiniK", MessageType: "privmsg", Me: false, Length: 0},
			},
		*/
		{
