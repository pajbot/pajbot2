            ...
            {this.state.reports.map((report, index) =>
              <div className="report card mb-3" key={index}>
                ...
                <div className="card-body">
                  ...
                  <button className="card-link btn btn-danger" title="Bans the user" onClick={() => this.handleReport(report.Channel.ID, report.ID, ReportActionDismiss)}>Dismiss</button>
