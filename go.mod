module github.com/pajlada/pajbot2
...
require (
	...
	github.com/pajlada/botsync v0.0.0-20190419161848-a9c0ed96396a
	github.com/pajlada/go-twitch-pubsub v0.0.0-20190126132848-baf7430eb9e5
