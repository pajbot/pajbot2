    ...
    "modified": [
      ...
      "src/widgets/helper/ChannelView.cpp"
		...
		},
		{
			...
			expected: []string{
				"dependabot[bot] committed to pajbot2@master (2025-03-14 10:38:49 +0100 CET): build(deps): bump golang.org/x/net from 0.35.0 to 0.36.0 (#1323) https://github.com/pajbot/pajbot2/commit/e54931bba169449d7b5f91196602dbd3d0e5c0a6",
			},
		},
		{
			// fake 1
